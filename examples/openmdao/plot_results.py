...
"""
This file can be used to plot results from the cases.sql file produced from
optimization or parameter sweep run files. The cases.sql file must be in the same folder
to plot results. All plots will be saved in the current directory and not displayed.

This file is intended for a single design variable case; it will plot the first design variable
against all openmdao outputs specified in the openmdao_wrapper.py as well as the objective function
specified in the optimization runs. 

Note: if generation profiles are specified as outputs in the wrapper.py this file will not plot them
as they are times series arrays.
"""
